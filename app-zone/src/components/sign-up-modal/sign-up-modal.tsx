      ...
      <div className="bg-white p-8 rounded-2xl">
        ...
        <form className="space-y-5" onSubmit={submitForm} autoComplete="off">
          <div className="flex flex-col gap-2">
            <label htmlFor="sign-up-username" className="text-sm font-medium text-gray-700">
              Nome de Usuário
            </label>
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="sign-up-email" className="text-sm font-medium text-gray-700">
              Email
            </label>
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="sign-up-password" className="text-sm font-medium text-gray-700">
              Senha
            </label>
